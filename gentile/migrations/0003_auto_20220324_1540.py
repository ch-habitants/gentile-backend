...
from gentile.models.commune import generate_searchable_string
    ...
    with open('gentile.csv', 'r') as input:
        for line in input.readlines():
            ...
            commune = Commune(
                ...
                searchable_name=generate_searchable_string(commune_str),
                searchable_gentile=generate_searchable_string(gentile_str)
            )
